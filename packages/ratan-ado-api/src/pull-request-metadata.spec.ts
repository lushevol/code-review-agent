...
describe("getPullRequestMetadataById", () => {
  it("returns clone metadata without requesting remote diffs", async () => {
    ...
    const gitApi = {
      getPullRequestById: vi.fn().mockResolvedValue({
        ...
        repository: {
          ...
          sshUrl: "git@ssh.dev.azure.com:v3/org/project/target-repo",
        ...
        forkSource: {
          ...
          repository: {
            ...
            sshUrl: "git@ssh.dev.azure.com:v3/org/project/fork-repo",
          },
        },
    ...
    expect(result).toMatchObject({
      ...
      sourceSshUrl: "git@ssh.dev.azure.com:v3/org/project/fork-repo",
